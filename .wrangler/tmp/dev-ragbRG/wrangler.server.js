// .wrangler/tmp/bundle-mNuHhn/checked-fetch.js
...
// src/app/server/web-public/ui/page.tsx
var Page = (props) => {
  let head = void 0;
  let children = [];
  if (props.children.forEach) {
    props.children.forEach((child) => {
      const isHead = child.tag && typeof child.tag === "function" && (child.tag.name && child.tag.name === "Head");
      if (isHead) {
        head = child;
      } else {
        children.push(child);
...
var Content = (props) => /* @__PURE__ */ jsxDEV2(Fragment2, { children: [
  /* @__PURE__ */ jsxDEV2("header", { children: /* @__PURE__ */ jsxDEV2("h1", { children: "This is the header" }) }),
  /* @__PURE__ */ jsxDEV2("main", { children: props.children }),
  /* @__PURE__ */ jsxDEV2("footer", { children: "This is the footer." })
] });

// src/app/server/web-public/routes/home/indexView.tsx
var view = () => /* @__PURE__ */ jsxDEV2(Page, { title: "Welcome to the public home page!", children: /* @__PURE__ */ jsxDEV2(Content, { children: [
  /* @__PURE__ */ jsxDEV2("h2", { children: "This is some content" }),
  /* @__PURE__ */ jsxDEV2("div", { children: /* @__PURE__ */ jsxDEV2("img", { alt: "a cat", src: "/assets/cat.jpg" }) })
] }) });
var indexView_default = view;

// src/app/server/web-public/routes/home/indexController.ts
var controller = new Hono2();
controller.get("/", (c) => {
  return c.render(indexView_default());
});
var indexController_default = controller;

// src/app/server/web-public/routes/secure/signInController.ts
var controller2 = new Hono2();
controller2.get("/", (c) => {
  return c.text("Hello from /secure/signin");
});
var signInController_default = controller2;

// src/app/server/web-public/app.ts
var app = new Hono2();
app.route("/", indexController_default);
app.route("/secure/signin", signInController_default);
var app_default = app;

// src/app/server/main.ts
var app2 = new Hono2();
app2.route("/p", app_default);
app2.get("/", (c) => {
  return c.redirect("/p");
});
var main_default = app2;
...
// src/app/server/wrangler.server.ts
import manifest from "__STATIC_CONTENT_MANIFEST";
main_default.get("/*", module({ root: "./wwwroot/", manifest }));
main_default.get("/favicon.ico", module({ path: "./wwwroot/favicon.ico", manifest }));
var wrangler_server_default = main_default;
...
// .wrangler/tmp/bundle-mNuHhn/middleware-insertion-facade.js
wrangler_server_default.middleware = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default,
  ...wrangler_server_default.middleware ?? []
].filter(Boolean);
var middleware_insertion_facade_default = wrangler_server_default;
...
// .wrangler/tmp/bundle-mNuHhn/middleware-loader.entry.ts
    ...
    fetch(request, env, ctx) {
      const dispatcher = function(type, init) {
        if (type === "scheduled" && worker.scheduled !== void 0) {
          const controller3 = new __Facade_ScheduledController__(
            Date.now(),
            init.cron ?? "",
            () => {
            }
          );
          return worker.scheduled(controller3, env, ctx);
        }
      };
  ...
  return class extends klass {
    ...
    #dispatcher = (type, init) => {
      if (type === "scheduled" && super.scheduled !== void 0) {
        ...
        return super.scheduled(controller3);
      }
    };
    fetch(request) {
...
//# sourceMappingURL=wrangler.server.js.map
